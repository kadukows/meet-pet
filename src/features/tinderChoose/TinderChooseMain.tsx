...
const TinderChooseMain = (props: Props) => {
    return (
        <Box sx={{ height: '90vh', width: 'inherit' }}>
            <Box sx={{ width: '60%', float: 'left' }}>
                <Paper sx={{ mr: 1, p: 1 }}>
                    <BigText />
                </Paper>
            </Box>
            <Box sx={{ width: '40%', height: '100%', float: 'left' }}>
                <Paper
                    sx={{
                        mb: 1,
                        p: 1,
                ...
                <Paper sx={{ mb: 1, p: 1, overflow: 'auto', height: '45%' }}>
                    <BigText />
                </Paper>
                <Paper sx={{ mb: 1, p: 1, overflow: 'auto', height: '10%' }}>
                    <BigText />
                </Paper>
            </Box>
        </Box>
